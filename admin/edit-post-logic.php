...
if(isset($_POST['submit'])) {
    ...
    if(!$title) {
        ...
        $_SESSION['edit-post'] = "Couldn't update posts. Invalid from data on edit post page";
    } elseif (!$body) {
        $_SESSION['edit-post'] = "Couldn't update posts. Invalid from data on edit post page";
    } else {
        // delete existing thumbani if new thumbnail is available
        if($thumbnail['name']) {
            ...
            if(in_array($extension, $allowed_files)) {
                ...
                move_uploaded_file($thumbnail_tmp_name, $thumbnail_destination_path);
                    ...
                    $_SESSION['edit-post'] = "Couldn't update posts. Thumbnail size too big. Should be less than 2mb.";
                }
            } else {
                $_SESSION['edit-post'] = "Couldn't update posts. Thumbnail should be png, jpg, or jpeg";
            }
        }
    }
